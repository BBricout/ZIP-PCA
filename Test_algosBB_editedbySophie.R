...
plot(log(1 + data$Y[data$Y !=0]), log(1 + pred.init[data$Y != 0]), main = "Prediction,Log. Init",col='red',ylim=range(log(1 + data$Y[data$Y !=0]))) ; abline(0,1)
plot(log(1 + data$Y[data$Y !=0]), log(1 + pred[data$Y != 0]), main = "Prediction,Log . Hat") ; abline(0,1)
plot( data$Y[data$Y !=0], pred.init[data$Y != 0], main = "Prediction. Init",col='red',ylim=range(data$Y[data$Y !=0])) ; abline(0,1)
plot( data$Y[data$Y !=0], pred[data$Y != 0], main = "Prediction. Hat") ; abline(0,1)
